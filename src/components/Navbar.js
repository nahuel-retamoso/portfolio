...
const Navbar = () => {
    return (
       <Flex zIndex='overlay' backdropFilter='blur(10px)' bg='whiteAlpha.100' pos='fixed' w='100%' h='7vh' align='center' >
            <Flex ml={{base: '5%', '2xl': '20%'}} w={{base: '45%', '2xl': '25%'}} justify='center' align='center' >
                <Image mb='2%' boxSize={{base: '40%', '2xl': '19%'}} src="./cat.png" alt="cat" />
                <Text ml='3%' color='whiteAlpha.900' fontSize={{base: '0.8em', '2xl': '1.2em'}} as='b' fontFamily='monospace'>Nahuel Retamoso's portfolio</Text>
            </Flex>
            ...
            <Button bgColor='gray.400' ml='5%' mr={{base: '5%', '2xl': '20%'}} w='3%' h='70%' >
                <MoonIcon />
            </Button>
       </Flex>
    );
