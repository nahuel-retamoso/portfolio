...
const Navbar = () => {
    return (
       <Flex zIndex='overlay' backdropFilter='blur(10px)' bg='whiteAlpha.100' pos='fixed' w='100%' h='7vh' align='center' >
            <Flex ml='20%' w='25%' justify='center' align='center'>
                <Image mb='2%' boxSize='19%' src="./cat.png" alt="cat" />
                <Text ml='3%' color='whiteAlpha.900' fontSize='1.2em' as='b' fontFamily='monospace'>Nahuel Retamoso's portfolio</Text>
            </Flex>
