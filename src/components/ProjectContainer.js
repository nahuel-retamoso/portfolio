...
const ProjectContainer = () => {
    return (
        <Flex direction='column' mt='3%' w={{base:'90%', '2xl': '48%'}} h={{base: 'fit-content', '2xl': 'fit-content'}} align='center'>
            <Divider />
            <Text color='whiteAlpha.900' mt='45' mb='5%' p='0.5%' bgColor='blackAlpha.300' >Take a look at my work ㋡</Text>
            <Grid w='93%' h='100%' templateColumns={{base: 'repeat(1, 1fr)', '2xl': "repeat(2, 1fr)"}} gap={10}>
