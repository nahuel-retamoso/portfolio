    ...
    return (
        <Flex direction='column' mt='3%' w='48%' h='110vh' align='center'>
            ...
            <Grid w='93%' h='100%' templateColumns="repeat(2, 1fr)" gap={6}>
                ...
                <Project title='Movie Notes' description='A note app only for movies and series, register what you saw and make list' source='https://github.com/nahuel-retamoso/celluloid-retamoso' website='google.com' image='./ecommerce.png' />
